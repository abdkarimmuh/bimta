		...
		<form action="" method="POST" class="form-horizontal" role="form">
				...
				<div class="form-group">
					...
					<div class="col-sm-6">
						...
						<input type="text" name="nim" id="input" class="form-control" readonly="" value="<?php echo $row['nim']; ?>" required="required">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-6">
						<input type="hidden" name="id_subject" value="<?php echo $id; ?>">
						<input type="text" name="subject" id="input" class="form-control" value="<?php echo $row['subject']; ?>" required="required">
					</div>
				</div>
