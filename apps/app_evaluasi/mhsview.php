...
<div class="panel panel-default">
  <div class="panel-heading">
    <?php             
      $stmt = $db_con->prepare("SELECT * FROM judul_ta, mahasiswa, dosen where mahasiswa.nim='$_SESSION[user_session]' && judul_ta.nim=mahasiswa.nim && dosen.id_dosen=mahasiswa.id_dosen");
      $stmt->execute();
