...
<div class="panel panel-default">
  ...
  <?php             
      $stmt2 = $db_con->prepare("SELECT * FROM evaluasi, prodi, jurusan, mahasiswa where evaluasi.nim_mhs='$id' && mahasiswa.nim='$id' && mahasiswa.id_prodi=prodi.id_prodi && jurusan.id_jurusan=prodi.id_jurusan");
      $stmt2->execute();
  ...
  <table class="w3-table-all w3-card-2 w3-centered" width="94%" height="321" border="1" align="center">
    ...
    <div class="batas"></div>
  <span>
  <p><div align="right"><a class="btn btn-info" href="?apps=evaluasi&amp;act=editevaluasi&amp;id=<?php echo $id; ?>" title="Edit Evaluasi"><span class="fa fa-edit"></span> Evaluasi Ulang Mahasiswa</a> <a href="?apps=judulta" class="btn btn-warning">Kembali</a></div></p></span>
  </div>
</div>
