	...
	<div class="panel-body">
		<form action="" method="POST" class="form-horizontal" role="form">
				...
				<div class="form-group">
					...
					<div class="col-sm-6">
						<input type="text" name="nim" id="input" class="form-control" placeholder="NIM berupa 10 angka" value="" required="required">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-6">
						<input type="text" name="nm_mhs" id="input" class="form-control" placeholder="Nama lengkap mahasiswa" value="" required="required">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-6">
						...
						<input type="text" name="" id="input" class="form-control" readonly="" value="<?php echo $row['nama_prodi']; ?>" required="required">
					</div>
				</div><?php }?>
				...
				<div class="form-group">
					...
					<div class="col-sm-6">
						<input type="text" name="th_bimbingan" id="input" class="form-control" readonly="" value="<?php $tahun=date("Y"); echo $tahun; ?>" required="required">
					</div>
				</div>	
