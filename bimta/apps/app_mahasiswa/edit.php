    ...
    <form action="" method="POST" class="form-horizontal" role="form">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-6">
          ...
          <input type="number" maxlength="10" name="nim" readonly="" id="input" class="form-control"
      ...
      <div class="form-group">
        ...
        <div class="col-sm-6">
          <input type="hidden" name="nim" value="<?php echo $id; ?>">
          <input type="text" pattern="^[a-zA-Z ]{2,30}$" name="nm_mhs" id="input" class="form-control" value="<?php echo $row['nm_mhs']; ?>"
            required="required">
        </div>
      </div>
