	...
	<div class="panel-body">
		<form action="" method="POST" class="form-horizontal" role="form">
				...
				<div class="form-group">
					...
					<div class="col-sm-6">
						<input type="text" name="subject" id="input" class="form-control" value="" placeholder="Subjek akan otomatis menjadi materi dalam kartu bimbingan" required="required">
					</div>
				</div>
