  ...
  <div class="panel-heading">
    ...
    <div class="panel-body">
      ...
      <div class="w3-panel2 w3-subject w3-topbar w3-bottombar w3-border-color">
        ...
        <p class="color_text"><i class="fa fa-calendar-o"></i>
          <?php $tgl=date_create($row['tgl']); echo date_format($tgl, 'd F Y, H:i'); ?></p>
      </div>
      <?php							
      ...
      <div class="w3-panel w3-padding w3-mhs w3-right-align col-sm-9 col-sm-offset-3">
        ...
        <p><?php echo $row_2['comment']; ?></p>
        <p class="time-right">
          <?php if ($row_2['status_read']=="1") { echo "Read"; } elseif ($row_2['status_read']=="0") { echo "Unread"; } ?>
          | <?php $tgl2=date_create($row_2['tgl']); echo date_format($tgl2, 'd F Y, H:i'); ?> </p>
      </div>
      <?php } } ?>
      <form action="" method="POST" class="form-horizontal" role="form">
        <div class="form-group">
          <div class="col-sm-12">
            <input type="hidden" name="pengirim"
              value="<?php if ($_SESSION['user_level']=='mahasiswa') { echo "mahasiswa"; } else { echo "dosen"; } ?>">
            <input type="hidden" name="id_pesantambahan" value="<?php echo $id; ?>">
            <textarea type="text" name="comment" placeholder="Type your comment" value="" id="input"
        ...
        <div class="form-group">
          <div class="col-sm-12">
            ...
            <button name="kirim_comment" type="submit" class="letak-button btn btn-primary"><span
                class="fa fa-send"></span> Kirim</button>
          </div>
        </div>
      </form>
