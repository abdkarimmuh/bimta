		...
		<form action="" method="POST" class="form-horizontal" role="form">
				...
				<div class="form-group">
					...
					<div class="col-sm-6">
						...
						<input type="text" name="nim" id="input" class="form-control" value="<?php echo $row['nim']; ?>" readonly required="required">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-6">
						<input type="hidden" name="id_ta" value="<?php echo $id; ?>">
						<textarea type="text" name="judul1" id="input" class="form-control" required="required"><?php echo $row['judul1']; ?></textarea>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-6">
						<input type="hidden" name="id_ta" value="<?php echo $id; ?>">
						<textarea type="text" name="judul2" id="input" class="form-control" required="required"><?php echo $row['judul2']; ?></textarea>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-6">
						<input type="hidden" name="id_ta" value="<?php echo $id; ?>">
						<textarea type="text" name="judul3" id="input" class="form-control" required="required"><?php echo $row['judul3']; ?></textarea>
					</div>
				</div>
