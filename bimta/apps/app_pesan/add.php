	...
	<div class="panel-body">
		<form action="" method="POST" class="form-horizontal" role="form">
				...
				<div class="form-group">
					...
					<div class="col-sm-6">
						<input type="text" name="topik_pesan" id="input" placeholder="Judul pesan Anda" class="form-control" value="" required="required">
					</div>
				</div>
				...
				<div class="form-group">
				  ...
				  <div class="col-sm-6">
					    <textarea type="text" name="pesan" id="input" class="form-control" placeholder="Isi pesan Anda" value="" required="required"></textarea>
				  </div>
				</div>
