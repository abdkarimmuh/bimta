  ...
  <div class="panel-body">
    <form action="" method="POST" class="form-horizontal" role="form">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-6">
          <input type="text" name="topik_pesan" id="input" placeholder="Judul pesan Anda" class="form-control"
            value="<?php echo $row3['topik_pesan'] ?>" required="required">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-6">
          <textarea type="text" name="pesan" id="input" class="form-control" placeholder="Isi pesan Anda"
            required="required"><?php echo $row3['pesan']; ?></textarea>
        </div>
      </div>
