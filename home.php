      ...
      <div class='alert alert-success'>
        <marquee>
          <strong>HALO ' <?php 
					...
					elseif ($_SESSION['user_level']=='kaprodi') {echo $row4['nm_kaprodi'];} 
				?></strong> | Selamat datang di halaman <?php 
					if ($_SESSION['user_level']=='dosen') {echo "dosen pembimbing tugas akhir";}
					elseif ($_SESSION['user_level']=='mahasiswa') {echo "mahasiswa";}
					elseif ($_SESSION['user_level']=='admin') {echo "administrator";}
					elseif ($_SESSION['user_level']=='kaprodi') {echo "kepala prodi";}
				?>
